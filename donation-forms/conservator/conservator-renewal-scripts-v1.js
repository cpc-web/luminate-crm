...
/* March2015 - Mary/Bo edits on Eli/M+R Scripts */
...
console.log('calling clickLevel:',thisLabel);
		...
		function preSelect(myParameter) {
			var myLevel = myParameter.toString();
			var myLabel = $('#label_id_'+myLevel).get(0);
console.log('my level:',myLevel,' mylabel: ',myLabel);
			clickLevel(myLabel);
		}
		...
		//show higher levels <-- Mary and Bo deleted for now. 
		...
		[[?xxnullx::x[[S334:levelID]]x::preSelect(6);::preSelect([[S334:levelID]]);]]
